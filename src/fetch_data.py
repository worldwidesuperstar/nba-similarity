...
def fetch_top_100_pp48(season='2024-25'):
    # fetch top 100 in PER
    ...
    top100.to_csv('data/raw/top100_per.csv', index=False)
    print('saved top 100 players by PTS/48 to CSV.')
    return top100
...
def fetch_save_advanced_data(df, season='2024-25', delay=5):
    for idx, row in df.iterrows():
        ...
        general_data=robust_fetch_dashboard(player_id, season)
...
def robust_fetch_dashboard(player_id, season, max_retries=5, pause=5):
...
if __name__ == "__main__":
    top100 = fetch_top_100_pp48()
    fetch_save_advanced_data(top100)